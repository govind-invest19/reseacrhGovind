        ...
        return (
            <div>
                ...
                <Table>
                    ...
                    <TableBody>
                        {this.state.users && this.state.users.map((row: { id: {} | null | undefined; firstName: React.ReactNode; lastName: React.ReactNode; username: React.ReactNode; age: React.ReactNode; salary: React.ReactNode; }) => (
                            <TableRow>
