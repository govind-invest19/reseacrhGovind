...
class EditUserComponent extends Component<any,any>{
        ...
        return (
            <div>
                ...
                <form>
                        ...
                        <TextField type="text" placeholder="username" fullWidth margin="normal" name="username"  value={this.state.username}/>
